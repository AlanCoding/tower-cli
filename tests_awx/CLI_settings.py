...
# EC2_REGION_NAMES uses translation text, so axed
...
# GCE_REGION_CHOICES uses translation text, axed
...
LOGGING = {
    ...
    'formatters': {
        ...
        # FIXME: you will need this logger to run inventory imports
        # 'timed_import': {
...
# ----- start settings from development.py ------
...
BASE_VENV_PATH = os.getenv('VIRTUAL_ENV', '/usr/local')
ANSIBLE_VENV_PATH = BASE_VENV_PATH
AWX_VENV_PATH = BASE_VENV_PATH
